...
echo color("red"," ===========================\n");
echo color("red","| Claim Voucher New user|\n");
echo color("red","| Auto create jd.id X Redeem voucher |\n");
echo color("red","| github: dan34nd |\n");
echo color("red","| fanspage :4dan34nd|\n");
echo color("red","| Creator : abidandy.com          |\n");
...
// function change(){
        ...
        echo color("red","\n===========(REDEEM VOUCHER)===========");
        echo "\n".color("yellow","!] Claim voc new user");
        echo "\n".color("yellow","!] Please wait");
        for($a=1;$a<=3;$a++){
        echo color("yellow",".");
        sleep(1);
        }
        $code1 = request('/go-promotions/v1/promotions/enrollments', $token, '{"promo_code":"NEW USER"}');
        ...
        echo "\n".color("yellow","!] Claim voc NEWUSER");
        echo "\n".color("yellow","!] Please wait");
        for($a=1;$a<=3;$a++){
        echo color("yellow",".");
        sleep(1);
        ...
        sleep(3);
        $boba10 = request('/go-promotions/v1/promotions/enrollments', $token, '{"promo_code":"NEWUSER"}');
